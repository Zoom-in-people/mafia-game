...
window.showRoleDescriptions = function() {
    ...
    const guideText = `🔴 마피아 진영\n` +
        ...
        `⚪ 시민 진영\n` +
        `- 시민: 특별한 고유 능력은 없으나 투표를 통해 마피아를 검거합니다.\n` +
        `- 명의사: 밤마다 마피아의 공격으로부터 생존자 1명을 지정하여 수호(치료)합니다.\n` +
        `- 경찰: 밤마다 지목한 유저가 마피아 진영인지 시민 진영인지 판별합니다.\n` +
        ...
        `- 건달: 밤에 지목한 대상을 협박 폭행하여 다음 날 낮 투표 시간 동안 투표권을 완전히 박탈합니다.\n` +
        `- 연인: 항상 2명이 고정 배정되며, 연인 중 한 명이 마피아에게 저격을 받으면 다른 연인이 대신 몸을 던져 대리 사망 희생을 합니다.`;
